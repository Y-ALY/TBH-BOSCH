...
3. Either upload one or more files, or paste a local folder/file path, `file://` URL, or direct downloadable `https://` file URL. JSONL (`.jsonl`) is supported alongside JSON, CSV, text, logs, PDFs, Word, and Excel files.
